...
// The Main Class
open class SCLAlertView: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var onSelectValuePicker: ((_ value: String) -> ())?
    ...
    open func addCustomView(_ customView: UIView){
    ...
    open func addCustomIcon(_ image: UIImage?, color: UIColor? = nil) {
    ...
    open func showCustom(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0x22B573, colorTextButton: UInt=0xFFFFFF ) -> SCLAlertViewResponder {
    ...
    // showCustom(view, title, subTitle)
    open func showPicker(_ title: String, options: [Int], closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0x22B573, colorTextButton: UInt=0xFFFFFF, onSelectValue: @escaping (_ value: String) -> ()) -> SCLAlertViewResponder {
        onSelectValuePicker = onSelectValue
        if let firstValueOfOptions = options.first {
            onSelectValuePicker?("\(firstValueOfOptions)" )
        }
    ...
    open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil) -> SCLAlertViewResponder {
        ...
        case .custom:
            viewColor = customCircleColor != nil ? customCircleColor! : UIColor.white
        ...
        if let fCustomView = self.customView {
            fCustomView.backgroundColor = UIColor.clear
        }
    ...
    open func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        onSelectValuePicker?("\(pickerOptions![row])")
    }
